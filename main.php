...
$bot_token = getenv('BOT_TOKEN') ?: "8639314799:AAFeCskl1g0FIlC8BJAnAL55mrdVRYTlcYg"; // avval ENV'dan, bo'lmasa shu qiymatdan

define('API_KEY',$bot_token);
$obito_us = "6222096713"; // admin_id
$admins = file_get_contents("admin/admins.txt");
$admin = explode("\n",$admins);
$studio_name = file_get_contents("admin/studio_name.txt");
array_push($admin,$obito_us);
...
$web_urlis = "$protocol://$host_no_www$folder_path/main.php";

// ==== sql.php mazmuni shu yerga inline qilindi ====
...
// ==== sql.php mazmuni tugadi ====

// ==== animes.php mazmuni shu yerga inline qilindi ====
// Bu qism faqat brauzerdan (GET so'rov) ochilganda ishlaydi;
// Telegram webhook har doim POST yuboradi, shuning uchun bot logikasiga xalaqit bermaydi.
...
<body class="min-h-screen text-white p-4 md:p-8">
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      <?php
      $sql_animes = mysqli_query($connect, "SELECT * FROM animelar ORDER BY id DESC");
      while($row = mysqli_fetch_assoc($sql_animes)) {
        ...
        $telegram_link = "https://t.me/{$bot}?start=$id";
...
if (strpos($data, "sendto=") !== false) {
    ...
    $web_urlis = "$protocol://$host$uri/main.php";
